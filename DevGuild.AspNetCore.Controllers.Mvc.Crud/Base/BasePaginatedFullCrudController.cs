...
{
    public abstract class BasePaginatedFullCrudController<TIdentifier, TEntity, TIndexViewModel, TIndexItemModel, TDetailsModel, TCreateModel, TEditModel, TDeleteModel> : Controller
